...
var MallInscription = {
     ...
     */
    start: function (userName, email, responseUrl, options) {
        if (options === void 0) { options = _1.default.getDefaultOptions(); }
        return __awaiter(void 0, void 0, void 0, function () {
            var startRequest;
            return __generator(this, function (_a) {
                startRequest = new requests_1.StartRequest(userName, email, responseUrl);
                return [2 /*return*/, request_service_1.default.perform(startRequest, options)];
            });
        });
    },
    /**
     ...
     * @param options (Optional) You can pass options to use a custom configuration for this request.
     */
    finish: function (token, options) {
        if (options === void 0) { options = _1.default.getDefaultOptions(); }
        return __awaiter(void 0, void 0, void 0, function () {
            var finishRequest;
            return __generator(this, function (_a) {
                finishRequest = new requests_1.FinishRequest(token);
                return [2 /*return*/, request_service_1.default.perform(finishRequest, options)];
            });
        });
    },
    /**
     ...
     * @param options (Optional) You can pass options to use a custom configuration for this request.
     */
    delete: function (tbkUser, userName, options) {
        if (options === void 0) { options = _1.default.getDefaultOptions(); }
        return __awaiter(void 0, void 0, void 0, function () {
            var deleteRequest;
            return __generator(this, function (_a) {
                deleteRequest = new requests_1.DeleteRequest(tbkUser, userName);
                return [2 /*return*/, request_service_1.default.perform(deleteRequest, options)];
            });
        });
    },
};
