...
var capture_request_1 = require("./requests/capture_request");
var MallDeferredTransaction = __assign(__assign({}, mall_transaction_1.default), { 
    /**
     ...
     */
    capture: function (commerceCode, buyOrder, amount, authorizationCode, options) {
        if (options === void 0) { options = _1.default.getDefaultOptions(); }
        return __awaiter(void 0, void 0, void 0, function () {
            var captureRequest;
            return __generator(this, function (_a) {
                captureRequest = new capture_request_1.CaptureRequest(commerceCode, buyOrder, amount, authorizationCode);
                return [2 /*return*/, request_service_1.default.perform(captureRequest, options)];
            });
        });
    } });
