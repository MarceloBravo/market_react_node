...
var MallDeferredTransaction = __assign(__assign({}, mall_transaction_1.default), { 
     ...
     */
    capture: function (token, commerceCode, buyOrder, authorizationCode, amount, options) {
        if (options === void 0) { options = _1.default.getDefaultOptions(); }
        return __awaiter(void 0, void 0, void 0, function () {
            var captureRequest;
            return __generator(this, function (_a) {
                captureRequest = new requests_1.MallCaptureRequest(token, commerceCode, buyOrder, authorizationCode, amount);
