...
const Transaction = {
     ...
     */
    create: async (buyOrder, sessionId, amount, cvv, cardNumber, cardExpirationDate, options = TransaccionCompleta.getDefaultOptions()) => {
     ...
     * @param options (Optional) You can pass options to use a custom configuration for this request.
     */
    installments: async (token, installmentsNumber, options = TransaccionCompleta.getDefaultOptions()) => {
     ...
     * @param options (Optional) You can pass options to use a custom configuration for this request.
     */
    commit: async (token, idQueryInstallments = undefined, deferredPeriodIndex = undefined, gracePeriod = undefined, options = TransaccionCompleta.getDefaultOptions()) => {
     ...
     * @param options (Optional) You can pass options to use a custom configuration for this request.
     */
    status: async (token, options = TransaccionCompleta.getDefaultOptions()) => {
     ...
     * @param options (Optional) You can pass options to use a custom configuration for this request.
     */
    refund: async (token, amount, options = TransaccionCompleta.getDefaultOptions()) => {
