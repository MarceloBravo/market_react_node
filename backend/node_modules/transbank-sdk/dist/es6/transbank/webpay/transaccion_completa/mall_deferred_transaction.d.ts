...
declare const MallDeferredTransaction: {
    ...
    create: (buyOrder: string, sessionId: string, cvv: number | undefined, cardNumber: string, cardExpirationDate: string, details: import("../common/transaction_detail").default[], options?: Options) => Promise<any>;
    installments: (token: string, details: import("../common/installments_detail").default[], options?: Options) => Promise<any[]>;
    commit: (token: string, details: import("./common/commit_detail").default[], options?: Options) => Promise<any>;
