...
const MallDeferredTransaction = Object.assign(Object.assign({}, MallTransaction), { 
    /**
     ...
     */
    capture: async (token, commerceCode, buyOrder, authorizationCode, amount, options = TransaccionCompleta.getDefaultOptions()) => {
        let captureRequest = new MallCaptureRequest(token, commerceCode, buyOrder, authorizationCode, amount);
