...
const MallInscription = {
     ...
     */
    start: async (userName, email, responseUrl, options = Oneclick.getDefaultOptions()) => {
     ...
     * @param options (Optional) You can pass options to use a custom configuration for this request.
     */
    finish: async (token, options = Oneclick.getDefaultOptions()) => {
     ...
     * @param options (Optional) You can pass options to use a custom configuration for this request.
     */
    delete: async (tbkUser, userName, options = Oneclick.getDefaultOptions()) => {
