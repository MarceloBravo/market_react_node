...
const MallTransaction = {
     ...
     */
    authorize: async (userName, tbkUser, buyOrder, details, options = Oneclick.getDefaultOptions()) => {
     ...
     * @param options (Optional) You can pass options to use a custom configuration for this request.
     */
    status: async (buyOrder, options = Oneclick.getDefaultOptions()) => {
     ...
     * @param options (Optional) You can pass options to use a custom configuration for this request.
     */
    refund: async (buyOrder, commerceCode, childBuyOrder, amount, options = Oneclick.getDefaultOptions()) => {
