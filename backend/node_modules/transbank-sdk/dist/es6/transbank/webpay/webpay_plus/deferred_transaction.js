...
const DeferredTransaction = Object.assign(Object.assign({}, Transaction), { 
     ...
     */
    capture: async (token, buyOrder, authorizationCode, amount, options = WebpayPlus.getDefaultOptions()) => {
        return RequestService.perform(new CaptureRequest(token, buyOrder, authorizationCode, amount), options);
    } });
