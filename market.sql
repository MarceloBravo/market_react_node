...
-- Records of clientes
-- ----------------------------
INSERT INTO `clientes` VALUES (2, '11.111.111-1', 'Marcelo', 'Bravo', 'Castillo', '12 Norte 16 Oriente, #2288, Talca', '07', '071', '07101', 'Talca', '$2b$10$Ead6AIGPX.1cs9UlPF6sxerGCO9/yFTjI7a6hpP.0nOT4Ve1UtNai', 'mabc@live.cl', '+ 56 9 98765432', NULL, '1234', 'Talca', 'Cerca de colegio', '2021-08-10 00:00:00', '2021-08-10 00:00:00', NULL);
...
INSERT INTO `despachos_ventas` VALUES (33, 54, '12 Norte 16 Oriente, #2288, Talca', '07', '071', '07101', 'Talca', '1234', 'Talca', 'Cerca de colegio', 1, NULL, '2021-08-23 00:00:00', '2021-08-26 00:00:00', NULL);
...
INSERT INTO `despachos_ventas` VALUES (35, 60, '12 Norte 16 Oriente, #2288, Talca', '07', '071', '07101', 'Talca', '1234', 'Talca', 'Cerca de colegio', 1, NULL, '2021-08-25 00:00:00', '2021-08-25 00:00:00', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 81 CHARACTER SET = utf8 COLLATE = utf8_spanish_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `imagenes_marquesina_home` VALUES (27, 'WIN_20200709_19_11_53_Pro (2).jpg', 'cccccccccccccccc', 'link cccccccccccccccc', 30, '2021-07-13 00:00:00', '2021-07-13 00:00:00', '2021-08-23 00:00:00');
...
) ENGINE = InnoDB AUTO_INCREMENT = 327 CHARACTER SET = utf8 COLLATE = utf8_spanish_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `imagenes_productos` VALUES (299, 62, '132525505833.JPG', 0, '2021-06-23 17:56:02', '2021-08-23 00:00:00', NULL);
INSERT INTO `imagenes_productos` VALUES (301, 61, 'lg x-cam.jpg', 1, '2021-06-24 10:50:43', '2021-07-24 00:00:00', NULL);
...
INSERT INTO `imagenes_productos` VALUES (304, 63, 'notebook idp3-c.jpg', 0, '2021-06-25 10:48:06', '2021-06-25 10:48:06', NULL);
...
INSERT INTO `imagenes_productos` VALUES (307, 60, 'dron phantom3-c.jpg', 0, '2021-06-25 10:55:46', '2021-07-25 00:00:00', NULL);
INSERT INTO `imagenes_productos` VALUES (308, 65, 'pesos tobillos muñecas 1.jpg', 1, '2021-06-26 12:16:05', '2021-06-26 12:16:05', NULL);
INSERT INTO `imagenes_productos` VALUES (309, 65, 'pesos tobillos muñecas 2.jpg', 0, '2021-06-26 12:16:05', '2021-06-26 12:16:05', NULL);
...
INSERT INTO `imagenes_productos` VALUES (316, 68, 'maquina abs 2.jpg', 0, '2021-06-26 13:08:42', '2021-06-26 13:08:42', NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 192 CHARACTER SET = utf8 COLLATE = utf8_spanish_ci ROW_FORMAT = Dynamic;
...
-- Records of permisos
-- ----------------------------
INSERT INTO `permisos` VALUES (1, 1, 1, 1, 1, 1, 1, '2021-02-06 22:33:59', '2021-08-26 00:00:00', NULL);
INSERT INTO `permisos` VALUES (2, 1, 2, 1, 1, 1, 1, '2021-02-06 22:33:59', '2021-08-26 00:00:00', NULL);
INSERT INTO `permisos` VALUES (3, 1, 3, 1, 1, 1, 1, '2021-02-08 13:32:30', '2021-08-26 00:00:00', NULL);
INSERT INTO `permisos` VALUES (5, 1, 4, 1, 1, 1, 1, '2021-02-10 11:39:33', '2021-08-26 00:00:00', NULL);
INSERT INTO `permisos` VALUES (6, 1, 5, 1, 1, 1, 1, '2021-02-10 11:42:38', '2021-08-26 00:00:00', NULL);
INSERT INTO `permisos` VALUES (7, 1, 6, 1, 0, 1, 1, '2021-04-28 20:03:52', '2021-08-26 00:00:00', NULL);
...
INSERT INTO `permisos` VALUES (44, 1, 11, 1, 1, 0, 0, '2021-05-26 00:00:00', '2021-08-26 00:00:00', NULL);
INSERT INTO `permisos` VALUES (45, 1, 14, 1, 1, 1, 1, '2021-06-12 00:00:00', '2021-08-26 00:00:00', NULL);
INSERT INTO `permisos` VALUES (46, 1, 15, 1, 1, 1, 1, '2021-06-14 00:00:00', '2021-08-26 00:00:00', NULL);
INSERT INTO `permisos` VALUES (47, 1, 16, 1, 1, 1, 1, '2021-06-18 00:00:00', '2021-08-26 00:00:00', NULL);
INSERT INTO `permisos` VALUES (48, 1, 17, 1, 1, 1, 1, '2021-06-19 00:00:00', '2021-08-26 00:00:00', NULL);
INSERT INTO `permisos` VALUES (49, 1, 18, 1, 1, 1, 1, '2021-06-21 00:00:00', '2021-08-26 00:00:00', NULL);
INSERT INTO `permisos` VALUES (50, 1, 19, 1, 1, 1, 1, '2021-06-23 00:00:00', '2021-08-26 00:00:00', NULL);
INSERT INTO `permisos` VALUES (51, 1, 20, 1, 0, 1, 0, '2021-07-06 00:00:00', '2021-08-26 00:00:00', NULL);
INSERT INTO `permisos` VALUES (52, 1, 21, 1, 1, 1, 1, '2021-07-10 00:00:00', '2021-08-26 00:00:00', NULL);
INSERT INTO `permisos` VALUES (53, 1, 22, 1, 1, 1, 1, '2021-07-20 00:00:00', '2021-08-26 00:00:00', NULL);
INSERT INTO `permisos` VALUES (54, 1, 23, 1, 0, 1, 1, '2021-08-26 00:00:00', '2021-08-26 00:00:00', NULL);
...
CREATE TABLE `precios_productos`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `producto_id` bigint(0) UNSIGNED NOT NULL,
  `precio` int(0) NOT NULL,
  `descuento` int(0) NOT NULL DEFAULT 0,
  `descuento_maximo` int(0) NOT NULL DEFAULT 0,
...
-- ----------------------------
INSERT INTO `precios_productos` VALUES (1, 60, 950, 5, 10, '2021-06-24 00:00:00', '2021-06-30 00:00:00', '2021-06-24 18:57:04', '2021-06-24 18:57:09', '2021-06-24 19:33:50');
INSERT INTO `precios_productos` VALUES (2, 60, 1500, -50, 0, '2021-06-24 00:00:00', '2021-06-30 00:00:00', '2021-06-24 19:13:30', '2021-06-24 19:13:35', '2021-06-24 19:33:53');
...
-- ----------------------------
INSERT INTO `productos` VALUES (60, 'Drone Phantom 3', 'Phantom 3 standar fácil de pilotar, vuelo estacionario de modo gps, registros automáticos de vuelo videocámara 2.7 k fotos de 12 megapixeles', 529990, 99, 3, 4, 1, 3, '2021-06-23 00:00:00', '2021-07-25 00:00:00', NULL);
INSERT INTO `productos` VALUES (61, 'Celular LG X CAM', 'Celular LG X-CAM liberado con chip movistar', 110000, 27, 3, 4, 1, 4, '2021-06-24 00:00:00', '2021-07-24 00:00:00', NULL);
INSERT INTO `productos` VALUES (62, 'Celular LG K41S', 'Celular LG K41S liberado con chip movistar', 110000, 29, 3, 4, 1, 4, '2021-06-24 00:00:00', '2021-08-23 00:00:00', NULL);
INSERT INTO `productos` VALUES (63, 'Notebook aweiou', 'Laptop portátil ', 50000, 50, 3, 3, 1, 3, '2021-07-03 00:00:00', '2021-07-25 00:00:00', NULL);
...
INSERT INTO `productos` VALUES (65, 'Pesos Para Tobillos Y Muñecas (3 Kg El Par)', 'Pesos Para Tobillos Y Muñecas (3 Kg El Par)', 9990, 93, 3, 2, 5, 6, '2021-07-26 00:00:00', '2021-07-26 00:00:00', NULL);
INSERT INTO `productos` VALUES (66, 'Maleta Pesas 20 Kg', 'Maleta Pesas 20 Kg, 4 discos de 2,5 Kilos, 4 pesos, de 1,5 Kilos, 2 barras de 2 Kilos c/u, 1 maleta plástica para transporte', 69990, 20, 3, 2, 5, 7, '2021-07-26 00:00:00', '2021-07-26 00:00:00', NULL);
INSERT INTO `productos` VALUES (67, 'Pesa Rusa Kettlebell 7 Kg', 'Pesa Rusa Kettlebell 7 Kg, Color negro', 21990, 15, 3, 5, 5, 7, '2021-07-26 00:00:00', '2021-07-26 00:00:00', NULL);
INSERT INTO `productos` VALUES (68, 'Six Pack Maquina Abdominales 5 min shape', 'Maquina Para Abdominales SIX PACKCon esta Maquina podrás realizar ejercicios abdominales.Trabaja los músculos del abdomen sector alto, medio, bajo y oblicuos, También hombros, pecho, espalda y piernas.Posee 6 posiciones para ajuste de dificultad + 1 posición para guardar el producto para que no utilice espacio al terminar de utilizarlo quedando totalmente vertical.Incluye Pantalla donde se puede ver: Tiempo ? Calorías quemadas ? Contador de Repeticiones ? Tiempo.Pantalla necesita 1 pila AA, ( INCLUIDA )Ancho máximo 54 cmAltura producto: Dependerá del nivel de dificultad seleccionado.Altura máxima: (posición guardado): 125 cm', 48990, 33, 3, 5, 5, 7, '2021-07-26 00:00:00', '2021-07-26 00:00:00', NULL);
INSERT INTO `productos` VALUES (69, 'Balon De Basketball 6 Muuk', 'La pelota de Basketball MUUK de tamaño Juvenil para entrenamiento, ideal para uso en exteriores. Elaborado con materiales altamente durables y resistentes, contiene cámara de butilo que retiene más el aire y viene encordado en nylon, lo que le hace conservar su esfericidad y un bote uniforme.', 10000, 7, 3, 4, 5, 7, '2021-07-26 00:00:00', '2021-08-22 00:00:00', NULL);
INSERT INTO `productos` VALUES (70, 'Zapatilla Under Armour GS Charged Pursuit 2 Negra Unisex', 'Zapatilla running para niñas y niños, modelo gs charged pursuit 2 de color negro, marca Under Armour', 27990, 37, 5, 6, 5, 5, '2021-08-02 00:00:00', '2021-08-02 00:00:00', NULL);
INSERT INTO `productos` VALUES (71, 'Zapatilla Running Adidas Unisex Tensaur Run K Negro', 'Zapatilla running unisex marca Adidas modelo Tensaur Run K de color negro con forro textil. Calzado con cordón y fit bajo el tobillo', 29990, 17, 5, 2, 5, 5, '2021-08-02 00:00:00', '2021-08-02 00:00:00', NULL);
