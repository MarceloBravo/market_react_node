    ...
    const validaDatos = (name, value) => {
        switch (name) {
            ...
            case 'url':
                ...
                else if (value.length < 3) { setErrors({ ...errors, url: 'El nombre de la URL debe tener almenos 3 carácteres. Ingrese una URL más larga.' })}
                else if (value.length > 100) { setErrors({ ...errors, url: 'El nombre de la URL debe tener hasta 50 carácteres. Ingrese una URL más corta.' }) }
                else {
                    setErrors({ ...errors, [name]: null })    
                }
                return 1;
